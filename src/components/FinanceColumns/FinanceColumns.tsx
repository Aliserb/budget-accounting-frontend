    ...
    <div className="flex flex-col items-center min-h-screen bg-gray-100">
      ...
      <main className="flex flex-row justify-center items-start flex-grow w-full p-6 space-x-8">
        ...
        <div className="flex flex-col w-1/2 max-w-md p-4 bg-white rounded-lg shadow-lg">
          <h2 className="text-2xl font-semibold text-green-500 mb-4">Income</h2>
          <div className="total_value font-semibold text-green-500 mb-4">+ 100 000 рублей</div>
        ...
        {/* Expenses Column */}
        <div className="flex flex-col w-1/2 max-w-md p-4 bg-white rounded-lg shadow-lg">
          <h2 className="text-2xl font-semibold text-red-500 mb-4">Expenses</h2>
          <div className="total_value font-semibold text-red-500 mb-4">- 50 000 рублей</div>
